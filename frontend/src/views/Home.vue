<template>
  <div>
    <div class="toolbar">
      <el-input v-model="filters.station" placeholder="车间" class="field" />
      <el-input v-model="filters.area" placeholder="工区" class="field" />
      <el-input v-model="filters.user" placeholder="负责人" class="field" />
    ...
    <el-dialog v-model="dialogVisible" title="站点信息" width="600px">
...
const filters = reactive({ station: '', area: '', user: '' })
...
const save = async () => {
  await http.post('/home/save', form)
  dialogVisible.value = false
  load()
}

const remove = async (id: number) => {
  await http.delete(`/home/${id}`)
  load()
}
